...
public class Test {
    ...
    public static void main(String args[]) throws IOException, URISyntaxException {
        String bearerToken = "AAAAAAAAAAAAAAAAAAAAAGbVaQEAAAAAQizRj5r8BMO1ENM0dXZ%2FThWGyFs%3D2C7CdmHjinAnBm0GdNcvT4QdWieDDEApEySsiVb6ShfJ1PIi3f";
        if (null != bearerToken) {
            //Replace the search term with a term of your choice
            String response = search("from:zamirmohyedin", bearerToken);
